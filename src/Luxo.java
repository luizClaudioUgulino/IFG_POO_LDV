public class Luxo extends Carro {
    ...
    public Luxo(String idDoCarro, String marca, String modelo, String placa, String ano, int valorDeLocacao,
            int quantidadeDeAirbags,
            int tamanhoPortaMalas, boolean gps, boolean CarroDisponível) {
        super(idDoCarro, marca, modelo, placa, ano, valorDeLocacao, 5, CarroDisponível, 10);
